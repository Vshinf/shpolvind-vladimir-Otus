	...
	<fragment>
		...
		<div v-if="!getIsLoading">
			...
			<div id="calc" class="container p-my">
				<div class="row">
					<calc-button v-on:click="clickButton(1)" text="1" class-color="btn-orange"></calc-button>
					<calc-button v-on:click="clickButton(2)" text="2" class-color="btn-orange"></calc-button>
					<calc-button v-on:click="clickButton(3)" text="3" class-color="btn-orange"></calc-button>
					<calc-button v-on:click="lastInput()" text="left" class-color="btn-gray"></calc-button>
				</div>
				<div class="row mt-4">
					<calc-button v-on:click="clickButton(4)" text="4" class-color="btn-orange"></calc-button>
					<calc-button v-on:click="clickButton(5)" text="5" class-color="btn-orange"></calc-button>
					<calc-button v-on:click="clickButton(6)" text="6" class-color="btn-orange"></calc-button>
					<calc-button v-on:click="nextInput()" text="right" class-color="btn-gray"></calc-button>

				</div>
				<div class="row mt-4">
					<calc-button v-on:click="clickButton(7)" text="7" class-color="btn-orange"></calc-button>
					<calc-button v-on:click="clickButton(8)" text="8" class-color="btn-orange"></calc-button>
					<calc-button v-on:click="clickButton(9)" text="9" class-color="btn-orange"></calc-button>
					<calc-button v-on:click="question()" text="question" class-color="btn-gray"></calc-button>
				</div>
				<div class="row mt-4">
					<div class="col-3 center"></div>
					<calc-button v-on:click="clickButton(0)" text="0" class-color="btn-orange"></calc-button>
					<div class="col-3 center"></div>
					<calc-button v-on:click="checkUser()" text="equals" class-color="btn-gray"></calc-button>
				</div>
			</div>
		</div>
		<div v-else>
